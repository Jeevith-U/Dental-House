...
const Tips = () => {
  ...
  return (
    <div
      className={`w-full h-max flex justify-center pb-4 mb-10 transfor transition-all duration-300 `}
    >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="px-1.5 py-4 text-sm w-full text-left bg-white bg-opacity-80">
          {explainer}
        </p>
      </div>
    </div>
