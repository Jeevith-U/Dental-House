...
const Landingpage = () => {
  return (
    <div className="h-screen w-full min-h-screen bg-opacity-40 text-slate-700 flex justify-center">
      ...
      <div className="mt-8 flex w-11/12 h-full justify-center items-center">
        <div className="w-3/5 px-10">
          ...
          <button className="bg-sky-500 hover:bg-slate-50 hover:text-slate-700 text-slate-50 py-2 px-4 rounded-lg font-comfortaa font-extrabold transition-colors duration-150 ease-in-out">
            Request Appointment
          </button>
        </div>
